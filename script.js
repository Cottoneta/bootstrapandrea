...
//var fondo = new Image();
//fondo.src = 'img/teammarigold.png';
...
// 🎯 Canvas en el contenedor
var canvas = document.createElement("canvas");
document.getElementById("cocodrilo-container").appendChild(canvas);
canvas.width = document.getElementById("cocodrilo-container").clientWidth;
canvas.height = 300; // altura fija
